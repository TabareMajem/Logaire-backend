// src/components/admin/integrations/create-integration-dialog.tsx -->
...
export function CreateIntegrationDialog({ open, onClose }: CreateIntegrationDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        ...
        <Form {...form}>
          {/* <form onSubmit={form.handleSubmit(createIntegration)} className="space-y-6"> */}
          <form onSubmit={form.handleSubmit((data) => { createIntegration(data); })} className="space-y-6" >
            <FormField
